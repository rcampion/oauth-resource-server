...
public class AuthenticationService {
	 ...
	 *                       "Unauthorized"); return null; } catch (IOException e1)
	 *                       { // TODO Auto-generated catch block
	 *                       e1.printStackTrace(); } } catch
	 *                       (AuthenticationCredentialsNotFoundException x) { try {
	 *                       response.sendError(HttpServletResponse.SC_UNAUTHORIZED,
	 *                       "Unauthorized"); return null; } catch (IOException e2)
	 *                       { // TODO Auto-generated catch block
	 *                       e2.printStackTrace(); } }
	 * 
	 ...
	 *                       UUID.randomUUID().toString(); Map<String, String>
	 ...
	 * 
	 *                       // Generate a random secret // String privateSecret =
	 *                       HmacSigner.generateSecret(); // String publicSecret =
	 *                       HmacSigner.generateSecret();
	 * 
	 *                       //Get jwt secret from properties String jwtSecret =
	 *                       securityProperties.getJwt().getSecret();
	 * 
	 *                       //Get hmac secret from config String hmacSharedSecret =
	 ...
	 * 
	 *                       for (UserDto userDto : userService.getUsers()) { if
	 *                       (userDto.getId() == (securityUser.getId())) { // Store
	 *                       in cache both private and public secrets
	 ...
	 * 
	 *                       // Set JWT as a cookie response.addCookie(jwtCookie);
	 * 
